...
Calendar.prototype.generateHTML = function(id) {
  ...
  html += '<a id="'+this.id+'-prev-calendar-link" class="prev-link" style="height:25px;width:25px" href="#" onclick="monthCalendar(\''+this.guid+'\','+prevYear+','+prevMonth+');return false;">&lArr;</a>';
  html +=  monthName + "&nbsp;" + this.year;
  html += '<a id="'+this.id+'-next-calendar-link" class="next-link" style="height:25px;width:25px" href="#" onclick="monthCalendar(\''+this.guid+'\','+nextYear+','+nextMonth+');return false;">&rArr;</a>';
  html += '</th></tr>';
